...
| $\log_2 3 \approx 1.58496$ | [BdW2002], [T2013] | Earlier explicit separation (pre-Kushilevitz): take a 3-variable base $g$ with $s(g)=3$ and $\deg(g)=2$ and compose it with itself $k$ times. Then $s(g^{\circ k})=3^k$ and $\deg(g^{\circ k})=2^k$, giving exponent $\log 3/\log 2=\log_2 3$. |
