...
$C_{18}$ is the least constant such that, whenever $A$ is a subset of ${\bf F}_2^n$ with $|A+A| \leq K|A|$, then $A$ can be covered by $K^{C_{18}+o(1)}$ cosets of a subspace of cardinality at most $|A|$, where the limit $o(1)$ is with respect to the limit $K \to \infty$.
...
- Conjectured to be finite by Katalin Marton, as recorded in [R1999].  It is the special case of the Polynomial Freiman-Ruzsa (PFR) conjecture when the ambient group is a vector space over the field ${\bf F}_2$.  (The precise formulation of the PFR conjecture in the case of unbounded torsion is still not fully settled.)
...
- [L2024] Liao, J.-J. *Improved Exponent for Marton's Conjecture in \mathbb{F}_2^n.* [arXiv:2404.09639](https://arxiv.org/abs/2404.09639) (2024).
