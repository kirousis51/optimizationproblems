...
We define $C_{7}$ to be the **Shannon capacity** of ${\mathcal C}_{7}$:

$$
C_{7} := \Theta({\mathcal C}_{7}),
$$
...
- [PS2018] Sven Polak, Alexander Schrijver, New lower bound on the Shannon capacity of $C_{7}$ from circular graphs, arXiv:1808.07438.
...
- [VZ2002] A. Vesel, J. Zerovnik, Improved lower bound on the Shannon capacity of $C_{7}$, Information Processing
