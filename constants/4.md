...
2
n
{\displaystyle 2^{n}} for any higher dimension, which was further improved to
2.2173
n
{\displaystyle 2.2173^{n}} by Edel (2004)[2] and then to
2.2180
n
{\displaystyle 2.2180^{n}} by Tyrrell (2022).[10] In December 2023, a team of researchers from Google's DeepMind published a paper where they paired a large language model (LLM) with an evaluator and managed to improve the bound to
2.2202
n
{\displaystyle 2.2202^{n}}.[11]
-->
