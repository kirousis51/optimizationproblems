...
Newman showed in [N1976] that there exists a finite constant $C_{22}$ (the de Bruijn–Newman constant) such that the zeros of $H$ are all real precisely when $\lambda \geq C_{22}$.
...
- The Riemann hypothesis holds iff $C_{22} = 0$, so the lower bound likely cannot be proved upon.
