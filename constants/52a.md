...
Let $m,n$ be positive integers and let $V$ be a set of $n$ Boolean variables. By a random formula of density $m/n$, we mean a collection of $m$ clauses selected u.a.r. with replacement from the set of $8{{n}\choose{3}}$ clauses on three distinct variables from $V$. For linguistic convenience, formulas with variables from $V$ will be called $n$-formulas.  
