...
$C_{4}$ is the largest constant such that, for large $n$, there exists subsets of $\mathbb F_{3}^n$ of cardinality $(C_{4}-o(1))^{n}$ that are *cap sets*, i.e., they do not contain any lines (length three progressions).
...
- Any cap set $A$ in $\mathbb F_{3}^n$ gives a lower bound $C_{4} \geq \lvert A\rvert^{1/n}$ by taking Cartesian powers.
