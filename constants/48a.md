...
The constant $C_{48}$ is the maximum approximation ratio to quantum max cut for any polynomial-time algorithm, 
$$C_{48} = \sup_f \min_G
...
| ----- | --------- | -------- |
| $\alpha < 1$ | [PG25] | There exists $\alpha<1$, such that it NP-hard to compute a value approximating QMC to within approximation ratio $\alpha$. |
...
Kunal Marwaha and James Sud, [webpage](https://marwahaha.github.io/quantum-maxcut-reference/).
...
Used Claude for double-checking references.
